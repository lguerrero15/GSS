...
$H_0$: there's no relationship between opinion on the death penalty and gun ownership.

$H_A$: there is relationship between opinion on the death penalty and gun ownership.
...
so we use a cat~cat analysis
chi-squared test of independance, fisher exact test for odds ratio.  
